  ...
  <div class="main-create-murr-container">
    ...
    <div class="header-buttons">
      ...
      <el-popover
        ...
        <i class="el-icon-s-operation operation-icon pointer"
           slot="reference"
           @click="visiblePopover = !visiblePopover"></i>
      ...
      <div>
        <a href="#"
           @click="changeShowAlmostDone">
          <i class="el-icon-arrow-right hide-icon__main-slide-fade-container"></i>
        </a>
      </div>
    </div>
    ...
    <div class="main-create-murr">
      <div class="create-murr-area">
        ...
        <div v-if="murrHeaderEmpty"
             class="m-form__help error-text">
        ...
        <transition
            name="slide-fade-minus-x"
            mode="out-in">

          <div v-if="showAlmostDone"
               class="almost-done-popup">
            ...
            <div class="actions">
              ...
              <div class="modal-mask"
                ...
                <el-button class="murr-button__success"
              ...
              <div v-if="showEditMurrHeaderModal"
                   class="modal-mask">
        ...
        tools: {
          ...
          image: {
            ...
            config: {
              ...
              endpoints: {
                byFile: axios_defaults_baseURL + '/api/murr_card/save_editor_image/',
              }
            }
          },
          paragraph: {
